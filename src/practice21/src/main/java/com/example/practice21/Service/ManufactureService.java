...
import com.example.practice21.DTO.ManufactureDTO;
import com.example.practice21.DynamicSpecifications;
import com.example.practice21.Entity.Manufacture;
import com.example.practice21.Repository.ManufactureRepo;
...
public class ManufactureService {
    ...
    public String addManufacture(ManufactureDTO manufactureDTO){
        ...
        emailService.sendEmail("add manufacture");
    ...
    public ManufactureDTO getManufacture(Long id) throws Exception{
        ...
        if (manufacture.isPresent()) {
            ...
            emailService.sendEmail("get manufacture by id");
            return new ManufactureDTO(manufacture.get());
        }
        log.info("Exception: manufacture with id: " + id + " was not found");
        emailService.sendEmail("Exception: manufacture with id: " + id + " was not found");
    ...
    public List<ManufactureDTO> getAllManufactures(){
        ...
        emailService.sendEmail("get all manufactures");
    ...
    public List<ManufactureDTO> getManufacturesByFilter(Map<String, Object> filters){
        ...
        emailService.sendEmail("get manufactures by filter");
    ...
    public String  removeManufacture(Long id) throws Exception{
        if(manufactureRepo.findById(id).isPresent()) {
            ...
            emailService.sendEmail("manufacture with id: " + id + " has been removed");
            return "Мануфактура с id: " + id + " удалена!";
        }
        log.info("manufacture with id: " + id + " was not found");
        emailService.sendEmail("manufacture with id: " + id + " was not found");
